      ...
      <section className="py-20 bg-white">
        <div className="container max-w-3xl">
          ...
          <div className="prose prose-lg max-w-none space-y-6">
            ...
            <h2 className="text-2xl font-bold">2. License</h2>
            <p>
            ...
            <h2 className="text-2xl font-bold">3. Use Restrictions</h2>
            <p>
              You agree not to:
            </p>
            <ul>
            ...
            <p>
              Questions about these terms? <a href="/contact" className="text-brand hover:underline">Contact us</a>.
            </p>
          </div>
        </div>
      </section>
